...
#run_with_ngrok(app)
model = joblib.load("/app/vessel-prediction2/Vessel_Prediction/model_bi.pkl")
# model = pickle.load(open('weight_pred_model.pkl', 'rb'))
# Ush Engineering\Projects\hero_project\Vessel_Prediction\

model1 = joblib.load("/app/vessel-prediction2/Vessel_Prediction/model_gc.pkl")

model2 = joblib.load("/app/vessel-prediction2/Vessel_Prediction/model_gp.pkl")

model3 = joblib.load("/app/vessel-prediction2/Vessel_Prediction/model_mt.pkl")

model4 = joblib.load("/app/vessel-prediction2/Vessel_Prediction/model_mtgc.pkl")

model5 = joblib.load("/app/vessel-prediction2/Vessel_Prediction/model_st.pkl")

model6 = joblib.load("/app/vessel-prediction2/Vessel_Prediction/model_wt.pkl")

model7 = joblib.load("/app/vessel-prediction2/Vessel_Prediction/model_zc.pkl")

DAYS = joblib.load("/app/vessel-prediction2/Vessel_Prediction/daysbi.pkl")

DAYS1 = joblib.load("/app/vessel-prediction2/Vessel_Prediction/daysgc.pkl")

DAYS2 = joblib.load("/app/vessel-prediction2/Vessel_Prediction/daysgp.pkl")

DAYS3 = joblib.load("/app/vessel-prediction2/Vessel_Prediction/daysmt.pkl")

DAYS4 = joblib.load("/app/vessel-prediction2/Vessel_Prediction/daysmtgc.pkl")

DAYS5 = joblib.load("/app/vessel-prediction2/Vessel_Prediction/daysst.pkl")

DAYS6 = joblib.load("/app/vessel-prediction2/Vessel_Prediction/dayswt.pkl")

DAYS7 = joblib.load("/app/vessel-prediction2/Vessel_Prediction/dayszc.pkl")
